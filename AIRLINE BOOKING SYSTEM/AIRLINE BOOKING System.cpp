...
const char l_destination[5][20]={"MANILA","PAMPANGGA","BORACAY","VISAYA","MINDANAO"};	//local Destination
const char i_destination[11][20]={"LONDON","PHILIPPINES","DUBAI","RIYADH","BEIJING","PARIS","CANBERRA","TOKYO","WASHINGTON","CANADA","KOREA" }; //International Destination
	...
	bool ldest()
	{
		...
		else
		{
			...
			if(m==1&&n==1)
			{
				...
				cout<<endl<<"Price: "<<payment<<" PHP/seat"<<endl;
				return true;
			}
			else
				return false;
		...
		bool idest(string pass)
	{
		...
		void Registration()
		{
			...
			if(k==49)
			{
				...
				<<endl<<"Time: 4.00 PM"
				<<endl<<"Ticket: HF"<<tkt
				<<endl<<"Bill(in PHILIPPINE PESO): "<<payment<<"/-"<<endl;
				outfile.close();
			}
			else if(k==50)
			{
...
cout<<"========================================================================================================================";
	cout<<"\n\t\t\t\t\t\tCOMPUTER PROGRAMMING RLO\n\t\t\t\t\t\tAIRLINE BOOKING SYSTEM"<<endl;
cout<<"========================================================================================================================"<<endl<<endl;

cout<<"========================================================================================================================";
	cout<<endl<<"\t\t\t\t\tWelcome GROUP 6 AIRLINE BOOKING"<<endl<<endl;
cout<<"========================================================================================================================";

system("cls");
        cout<<"\n\n\n\t\t\t\t\tLOGIN BELOW"<<endl<<endl;
    cout<<"\t\t\t\t\t\tusername:";
    cin>>userreg;
    cout<<"\t\t\t\t\t\tpassword:";
    cin>>passreg;
    if (userreg == "admin",passreg== "admin"){
        cout<<"login Success"<<endl;
        loginsuccess = true;
    }else{

    cout<<"incorrect user or password!"<<endl;
    cout<<"try login again"<<endl<<endl;
    }
	...
	cout<<endl<<"\n\n\n\t\t\t\t\t\tWelcome GROUP 6 AIRLINE BOOKING"<<endl;
