...
if((strcmp(origin,"PAMPANGGA")==0)||(strcmp(origin,"BORACAY")==0)&&(strcmp(destination,"PAMPANGGA")==0)||(strcmp(destination,"BORACAY")==0))
	return payment=20000;
else if((strcmp(origin,"BORACAY")==0)||(strcmp(origin,"PAMPANGGA")==0)&&(strcmp(destination,"BORACAY")==0)||(strcmp(destination,"PAMPANGGA")==0))
	return payment=23927;
else if((strcmp(origin,"PAMPANGGA")==0)||(strcmp(origin,"MINDANAO")==0)&&(strcmp(destination,"PAMPANGGA")==0)||(strcmp(destination,"MINDANAO")==0))
	return payment=10101;
else if((strcmp(origin,"PAMPANGGA")==0)||(strcmp(origin,"QUETTA")==0)&&(strcmp(destination,"PAMPANGGA")==0)||(strcmp(destination,"QUETTA")==0))
	return payment=10101;
else if((strcmp(origin,"VISAYA")==0)||(strcmp(origin,"MANILA")==0)&&(strcmp(destination,"VISAYA")==0)||(strcmp(destination,"MANILA")==0))
	payment=33930;
else if((strcmp(origin,"BISAYA")==0)||(strcmp(origin,"PAMPANGGA")==0)&&(strcmp(destination,"BISAYA")==0)||(strcmp(destination,"PAMPANGGA")==0))
	return payment=60000;
else if((strcmp(origin,"BISAYA")==0)||(strcmp(origin,"MINDANAO")==0)&&(strcmp(destination,"BISAYA")==0)||(strcmp(destination,"MINDANAO")==0))
	return payment=93798;
else if((strcmp(origin,"MINDANAO")==0)||(strcmp(origin,"MANILA")==0)&&(strcmp(destination,"MINDANAO")==0)||(strcmp(destination,"MANILA")==0))
	return payment=73702;
else if((strcmp(origin,"MINDANAO")==0)||(strcmp(origin,"BORACAY")==0)&&(strcmp(destination,"MINDANAO")==0)||(strcmp(destination,"BORACAY")==0))
	return payment=22542;
}

int ipayment(char origin[30], char destination[30]){

if((strcmp(origin,"LONDON")==0)||(strcmp(origin,"PHILIPPINES")==0)&&(strcmp(destination,"LONDON")==0)||(strcmp(destination,"PHILIPPINES")==0))
	        return payment=17049;
else if((strcmp(origin,"PHILIPPINES")==0)||(strcmp(origin,"DUBAI")==0)&&(strcmp(destination,"PHILIPPINES")==0)||(strcmp(destination,"DUBAI")==0))
	        return payment=24112;
else if((strcmp(origin,"PHILIPPINES")==0)||(strcmp(origin,"RIYADH")==0)&&(strcmp(destination,"PHILIPPINES")==0)||(strcmp(destination,"RIYADH")==0))
	        return payment=48345;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"BEIJING")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"BEIJING")==0))
...
else if((strcmp(origin,"LONDON")==0)||(strcmp(origin,"PHILIPPINES")==0)&&(strcmp(destination,"LONDON")==0)||(strcmp(destination,"PHILIPPINES")==0))
	        return payment=47692;
else if((strcmp(origin,"LONDON")==0)||(strcmp(origin,"PHILIPPINES")==0)&&(strcmp(destination,"LONDON")==0)||(strcmp(destination,"PHILIPPINES")==0))
	        return payment=29530;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"DUBAI")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"DUBAI")==0))
	        return payment=35067;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"RIYADH")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"RIYADH")==0))
	        return payment=66964;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"BEIJING")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"BEIJING")==0))
	        return payment=62527;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"PARIS")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"PARIS")==0))
	        return payment=4436;
else if((strcmp(origin,"KOREA")==0)||(strcmp(origin,"CANBERRA")==0)&&(strcmp(destination,"KOREA")==0)||(strcmp(destination,"CANBERRA")==0))
	        return payment=157902;
else if((strcmp(origin,"PPHILIPPINES")==0)||(strcmp(origin,"TOKYO")==0)&&(strcmp(destination,"PHILIPPINES")==0)||(strcmp(destination,"TOKYO")==0))
